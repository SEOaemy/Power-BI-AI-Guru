...
export const LightBulbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-11.645 6.01 6.01 0 00-3 0 6.01 6.01 0 001.5 11.645M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
);
...
export const ClipboardIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a2.25 2.25 0 01-2.25 2.25H9.75A2.25 2.25 0 017.5 4.5v0c0-.212.03-.418.084-.612m7.5 0-3.75 3.75M9.75 12h4.5m-4.5 3h4.5m-4.5 3h4.5m3-15.75V21a2.25 2.25 0 002.25 2.25h-10.5A2.25 2.25 0 004.5 21V5.25c0-1.242 1.008-2.25 2.25-2.25h1.5" />
  </svg>
);
...
export const CloudArrowUpIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M3 13.5a9 9 0 1018 0c0-5.32-4.14-9.665-9.43-9.988" />
  </svg>
);
...
export const CalculatorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 6A2.25 2.25 0 015.625 3.75h12.75c1.242 0 2.25 1.008 2.25 2.25v10.5A2.25 2.25 0 0118.375 18.75H5.625A2.25 2.25 0 013.375 16.5V6z" />
  </svg>
);

export const PaintBrushIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a2.25 2.25 0 012.245 2.4 3 3 0 001.128 5.78 4.5 4.5 0 00-2.245-8.4c-.78 0-1.533.16-2.22.462m-3.386 6.836a15.998 15.998 0 001.622 3.385m-5.043-.025a15.998 15.998 0 01-3.388-1.621m7.543-3.386a15.998 15.998 0 00-1.622-3.385m3.386 5.043a2.25 2.25 0 002.4-2.245 3 3 0 015.78-1.128 4.5 4.5 0 00-8.4 2.245c0 .399.078.78.22 1.128zm0 0a15.998 15.998 0 00-3.388 1.621m5.043.025a15.998 15.998 0 01-1.622 3.385" />
  </svg>
);
...
export const TableCellsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125h17.25c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125m-17.25 0h17.25M4.5 4.5v.75A.75.75 0 013.75 6h-.75m0 0a.75.75 0 00-.75.75v10.5c0 .414.336.75.75.75h.75a.75.75 0 00.75-.75V6.75a.75.75 0 00-.75-.75h-.75zm15 0v.75a.75.75 0 00.75.75h.75m0 0a.75.75 0 01.75.75v10.5c0 .414-.336.75-.75.75h-.75a.75.75 0 01-.75-.75V6.75a.75.75 0 01.75-.75h.75zM4.5 12h15" />
  </svg>
);
...
export const CpuChipIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M15.75 3v1.5M12 4.5v-1.5m0 18v-1.5M15.75 21v-1.5m-4.5-16.5A2.25 2.25 0 008.25 4.5v15A2.25 2.25 0 0010.5 21.75h3A2.25 2.25 0 0015.75 19.5v-15A2.25 2.25 0 0013.5 2.25h-3z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75h6v10.5H9V6.75z" />
    </svg>
);
